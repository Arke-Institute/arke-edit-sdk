...
__export(react_exports, {
  ...
  useEditContext: () => useEditContext,
  useEditSession: () => useEditSession
});
...
function useEditSession(sdk, pi, options) {
  ...
  const setPrompt = (0, import_react.useCallback)(
    (target, prompt) => {
  ...
  const addCorrection = (0, import_react.useCallback)(
    (original, corrected, sourceFile) => {
      session?.addCorrection(original, corrected, sourceFile);
    },
    [session]
  );
  const setScope = (0, import_react.useCallback)(
    (scope) => {
...
var EditContext = (0, import_react2.createContext)(null);
function EditProvider({ config, children }) {
  const sdk = (0, import_react2.useMemo)(() => new ArkeEditSDK(config), [config]);
  const value = (0, import_react2.useMemo)(() => ({ sdk }), [sdk]);
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EditContext.Provider, { value, children });
}
function useEditContext() {
  const context = (0, import_react2.useContext)(EditContext);
  if (!context) {
